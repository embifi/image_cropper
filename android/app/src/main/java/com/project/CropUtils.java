...
//            final TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.CropImageView, 0, 0);
        ...
        public Bitmap getCroppedImage() {
            ...
            final float cropX = (bitmapLeft + Edge.LEFT.getCoordinate() - transX) / scaleX;
            final float cropY = (bitmapTop + Edge.TOP.getCoordinate() - transY) / scaleY;
    ...
    public enum Edge {
        ...
        public static float getWidth() {
            return Math.abs(Edge.RIGHT.getCoordinate() - Edge.LEFT.getCoordinate());
//            Log.d("getWidth","getWidth(): "+ (Edge.RIGHT.getCoordinate() - Edge.LEFT.getCoordinate()));
//            return Edge.RIGHT.getCoordinate() - Edge.LEFT.getCoordinate();
        }
        public static float getHeight() {
            return Math.abs(Edge.BOTTOM.getCoordinate() - Edge.TOP.getCoordinate());
//            Log.d("getHeight","getHeight(): "+ (Edge.BOTTOM.getCoordinate() - Edge.TOP.getCoordinate()));
